    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {loading ? (
        ...
        <>
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 mb-8">
            <h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">
              Live Odds - {odds.length} Game{odds.length !== 1 ? 's' : ''}
            </h2>
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Click on any game to get AI-powered betting analysis
            </p>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
          ...
          <ol className="space-y-2 text-gray-600 dark:text-gray-400 list-decimal list-inside">
            ...
            <li>Click on a game to get AI analysis</li>
            <li>Ask for multi-bet parlays or single picks</li>
